...
SUITE(DIFFUSION)
{
  ...
  //            median7x8_filtered.exo (square with polyhedra, mostly hexes,
  //            some others)
  ...
  //            tensor !=1, scalar = None
  //    analytic problem:
  //            Analytic00_Linear: coef=1, linear solution (exact for all
  //            methods!) Analytic00_Quadratic: coef=1, quadratic solution
  //            (exact for second order methods!)

  //            Analytic00b: 3D variant of Analytic00
  //            Analytic03: discontinuous scalarTensor<> coef, no scalar coef
  //            Analytic03b: same as 03, but withTensor<> coef=1 and scalar coef
  //            as the scalar
  //
...
#  endif
  ...
  //       MFD is still exact
  //       NLFV must converge to be exact.  Also, NLFV loses symmetry as it
  //       iterates.
#if ASSEMBLING
#  if FV
...
#  endif
#  if MFD
  // on mfd: default, these have a tolerance of 1.e-12.  On TPFA, it is the same
  // as FV?
...
#  if NLFV
  ...
  //   auto ana = Teuchos::rcp(new Analytic00(1, 1.0, 1.0, 1.1));
  //   testWGravity<Operators::PDE_DiffusionNLFVwithGravity>(
  //       ana, 1.1, "ifpack2: ILUT", "DirichletNeumannBox",
  //       "test/random10.exo", "nlfv", false,
  //       AmanziMesh::Entity_kind::UNKNOWN, 1.e-12, 20);
  // }
  ...
  //   testWGravity<Operators::PDE_DiffusionNLFVwithBndFacesGravity>(
  //       ana, 1.1, "ifpack2: ILUT", "DirichletNeumannBox",
  //       "test/random10.exo", "nlfv with bfaces", false,
  //       AmanziMesh::Entity_kind::UNKNOWN, 1.e-12, 20);
  // }
#  endif
  ...
  // NOTE: FV cannot be exact
  //       MFD is still exact
  //       NLFV must converge to be exact. By desing, NLFV loses symmetry as it
  //       iterates.
#  if FV
...
#  if NLFV
  ...
  //   auto ana = Teuchos::rcp(new Analytic00(1, 1.0, 1.0, 0.0));
  //   test<Operators::PDE_DiffusionNLFV>(
  //       ana, "ifpack2: ILUT", "DirichletNeumannBox",
  //       "test/median7x8_filtered.exo", "nlfv", false,
  //       AmanziMesh::Entity_kind::UNKNOWN, 1.e-12, 20);
  // }
  ...
  //   test<Operators::PDE_DiffusionNLFVwithBndFaces>(
  //       ana, "ifpack2: ILUT", "DirichletNeumannBox",
  //       "test/median7x8_filtered.exo", "nlfv with bfaces", false,
  //       AmanziMesh::Entity_kind::UNKNOWN, 1.e-12, 20);
  // }
...
#  if NLFV
  ...
  //   test<Operators::PDE_DiffusionNLFV>(
  //       ana, "ifpack2: ILUT", "DirichletNeumannBox",
  //       "test/circle_quad10.exo", "nlfv", false,
  //       AmanziMesh::Entity_kind::UNKNOWN, 1.e-11, 50);
  // }
  // TEST(Analytic02_Gravity_NLFV_DirichletNeumannBox_CircleQuad_ifpack2_ILUT) {
  //   auto ana = Teuchos::rcp(new Analytic02(2, 0.1));
  //   testWGravity<Operators::PDE_DiffusionNLFVwithGravity>(
  //       ana, 0.1, "ifpack2: ILUT", "DirichletNeumannBox",
  //       "test/circle_quad10.exo", "nlfv", false,
  //       AmanziMesh::Entity_kind::UNKNOWN, 1.e-11, 50);
  // }
  ...
  //   test<Operators::PDE_DiffusionNLFVwithBndFaces>(
  //       ana, "ifpack2: ILUT", "DirichletNeumannBox",
  //       "test/circle_quad10.exo", "nlfv with bfaces", false,
  //       AmanziMesh::Entity_kind::UNKNOWN, 1.e-11, 50);
  // }
  ...
  //   test<Operators::PDE_DiffusionNLFVwithBndFaces>(
  //       ana, "ifpack2: ILUT", "DirichletNeumannBox", "Generate3D",
  //       "nlfv with bfaces", false, AmanziMesh::Entity_kind::UNKNOWN, 1.e-11,
  //       50);
  // }
...
#  endif
  ...
  // NOTE: FV cannot be exact
  //       MFD is still exact
  //       NLFV must converge to be exact. By design, NLFV loses symmetry as it
  //       iterates.
// #if FV
#if 0
