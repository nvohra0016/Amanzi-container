...
{
  if (argc < 4) {
    std::cout << "Usage: verify_operators  with_pc|direct  mesh_type  "
                 "mesh_size|mesh_file  scheme  tol  nloops  linsolver  test_id  "
                 "device\n\n"
                 "  (req) with_pc   = identity|diagonal|ifpack2: ILUT|ifpack2: RILUK\n"
                 "                    Hypre: AMG|Hypre: Euclid|Ginkgo: Jacobi\n"
                 "                    Trilinos: ML|Trilinos: MueLu\n"
                 "  (req) direct    = Amesos1: KLU|Amesos2: Basker|Amesos2: "
                 "SuperLUDist\n\n"
                 "  (req) mesh_type = "
                 "structured2d|structured3d|unstructured2d|unstructured3d\n"
                 ...
                 "  (opt) nloops    = number of iterations  (default is 1 for linear "
                 "solvers)\n"
                 ...
                 "  verify_operators \"Amesos1: KLU\" unstructured2d mymesh.exo mfd "
                 "1e-10 1 gmres \"03\" gpu\n";
    return 1;
  }
