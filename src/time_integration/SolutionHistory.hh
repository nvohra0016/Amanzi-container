...
template <class Vector>
void
SolutionHistory<Vector>::FlushHistory(double t, const Vector& x, const Vector& xdot)
{
  nvec_ = 0;
  RecordSolution(t, x, xdot);
}
...
template <class Vector>
void
SolutionHistory<Vector>::RecordSolution(double t, const Vector& x, const Vector& xdot)
{
  RecordSolution(t, x);
