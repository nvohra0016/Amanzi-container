...
template<class Mesh_type>
std::size_t computeMaxCellNumNodes(const Mesh_type& mesh);

template<class Mesh_type>
std::size_t computeMaxCellNumFaces(const Mesh_type& mesh);

template<class Mesh_type>
std::size_t computeMaxCellNumEdges(const Mesh_type& mesh);

template<class Mesh_type>
typename Mesh_type::Entity_ID_View
computeCellFaceAdjacentCells(const Mesh_type& mesh,
                         Entity_ID c, Parallel_kind ptype);

template<class Mesh_type>
int computeFaceAdjacentCell(const Mesh_type& mesh, Entity_ID c, Entity_ID f);
