...
TEST(SURFACE_COLUMN_MESH_3D)
{
  ...
  Teuchos::RCP<AmanziMesh::Mesh> mesh = Teuchos::rcp(new AmanziMesh::Mesh(mesh_fw, Teuchos::rcp(new AmanziMesh::MeshAlgorithms()), Teuchos::null));
  mesh->buildColumns();
  ...
  AmanziMesh::Mesh colmesh(colmesh_fw, Teuchos::rcp(new AmanziMesh::MeshColumnAlgorithms()), Teuchos::null); 
  ...
  AmanziMesh::Mesh col_surf(col_surf_fw, Teuchos::rcp(new AmanziMesh::MeshAlgorithms()), Teuchos::null); 
