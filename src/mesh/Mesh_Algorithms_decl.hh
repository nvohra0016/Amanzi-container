...
struct MeshAlgorithms {
  ...
  virtual inline AmanziGeometry::Point computeCellCentroid(const MeshHost& mesh, const Entity_ID c) const;
  ...
  virtual inline AmanziGeometry::Point computeFaceCentroid(const MeshHost& mesh, const Entity_ID f) const;
  ...
  virtual inline AmanziGeometry::Point computeFaceNormal(const MeshHost& mesh, const Entity_ID f,
          const Entity_ID c, int * const orientation) const;
  ...
  computeEdgeVector(const MeshHost& mesh, const Entity_ID e, const Entity_ID n, int * const orientation) const;
  ...
  virtual inline void computeCellFacesAndBisectors(const MeshHost& mesh, const Entity_ID cellid,
