...
******************************************************************* */
void MultiphaseMatrixFracture_PK::Setup()
{
  std::string passwd("");
...
******************************************************************* */
void MultiphaseMatrixFracture_PK::Initialize()
{
...
******************************************************************* */
bool MultiphaseMatrixFracture_PK::AdvanceStep(double t_old, double t_new, bool reinit)
{
...
* Residual evaluation
******************************************************************* */
void MultiphaseMatrixFracture_PK::FunctionalResidual(double t_old, double t_new,
...
******************************************************************* */
void MultiphaseMatrixFracture_PK::UpdatePreconditioner(double t,
...
******************************************************************* */
int MultiphaseMatrixFracture_PK::ApplyPreconditioner(Teuchos::RCP<const TreeVector> X,
